              ...
              {[
                ...
                return (
                  <div key={item.s} className="relative flex gap-3 cursor-pointer group" onClick={() => setStep(item.s)}>
                    <div className={`w-6 h-6 shrink-0 rounded-full flex items-center justify-center text-[10px] font-bold z-10 transition-colors ${isActive ? 'bg-indigo-600 text-white shadow-md shadow-indigo-200' :
                    ...
                    <div className="mt-0.5">
                      <div className={`text-xs font-bold leading-none mb-1 transition-colors ${isActive ? 'text-indigo-900' : isPassed ? 'text-slate-700' : 'text-slate-400'
                        }`}>{item.title}</div>
                      <div className={`text-[10px] transition-colors ${isActive ? 'text-indigo-500 font-medium' : 'text-slate-400'
                        }`}>{item.desc}</div>
                    </div>
                  </div>
                )
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            className={`px-4 py-2.5 rounded-lg text-xs font-bold transition-all whitespace-nowrap min-w-[80px] ${isPhoneVerified ? 'bg-indigo-50 text-indigo-600 border border-indigo-100' :
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-5">
                    ...
                    <div>
                      ...
                      <div className="flex p-1 bg-slate-100 rounded-lg shrink-0">
                        <button
                          onClick={() => setGender('M')}
                          className={`flex-1 py-1.5 text-xs font-bold rounded-md transition-all ${gender === 'M' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
                            }`}
                        >
                          남성
                        </button>
                        <button
                          onClick={() => setGender('F')}
                          className={`flex-1 py-1.5 text-xs font-bold rounded-md transition-all ${gender === 'F' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
                            }`}
                        >
                          여성
                        </button>
